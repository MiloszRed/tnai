...
namespace TNAI.MVC
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            //container.RegisterType<IUserStore<ApplicationUser>, UserStore<ApplicationUser>>(new HierarchicalLifetimeManager()); // B³¹d: Cannot access a disposed object. Object name: 'UserStore`1'.
            container.RegisterType<IUserStore<ApplicationUser>, UserStore<ApplicationUser>>(); // Dzia³a.
